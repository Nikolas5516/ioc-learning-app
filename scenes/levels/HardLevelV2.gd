...
@onready var btn_option1 = $OptionsContainer/ButtonOption1
@onready var btn_option2 = $OptionsContainer/ButtonOption2
@onready var btn_option3 = $OptionsContainer/ButtonOption3
